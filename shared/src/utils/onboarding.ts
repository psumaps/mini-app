...
const onboardingText = [
  ...
  [
    'Приложение создано как для студентов,',
    'так и для гостей нашего университета. Не забудь авторизоваться для доступа ко всему функционалу - инструкции в Настройках',
  ],
  [
