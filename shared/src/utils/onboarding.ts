...
const onboardingText = [
  ...
  [
    'Вкладка учебного расписание поможет',
    'попасть на все пары! Кликай место проведения и увидишь на карте нужную аудитория',
  ],
  [
  ...
  [
    ...
    'Но со временем список будет пополняться. Следи за обновлениями в нашем телеграм-канале!',
  ],
];
