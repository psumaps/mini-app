...
const Modal = ({
  ...
  return (
    ...
    >
      <div className="bg-cd_main dark:bg-cd_bg-block w-screen h-screen rounded-forty p-4 shadow-[0_0px_10px_0px_#DDDDDD] dark:shadow-[0_0px_10px_0px_#262626] transition-opacity duration-300 ease-in-out overflow-y-auto">
